 ...
 * @version     $Id: class.CeonURIMappingDeleteCategoriesObserver.php 14 May 2026 torvista
 */
 ...
 */
	public function notifier_admin_zen_remove_category(&$callingClass, $notifier, $paramsArray, &$category_id): void
    {
 ...
 *zc 1.5.6   $zco_notifier->notify('NOTIFIER_ADMIN_ZEN_REMOVE_CATEGORY', array(), $category_id);
 */
	public function updateNotifierAdminZenRemoveCategory(&$callingClass, $notifier, $paramsArray, &$category_id): void
    {

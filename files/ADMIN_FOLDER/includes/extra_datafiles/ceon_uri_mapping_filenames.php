 ...
 * @version     $Id: ceon_uri_mapping_filenames.php 14 May 2026 torvista
 */

if (!defined('FILENAME_CEON_URI_MAPPING_CONFIG')) {
    define('FILENAME_CEON_URI_MAPPING_CONFIG', 'ceon_uri_mapping_config');
}
if (!defined('FILENAME_CEON_URI_MAPPING_INSTALLATION_CHECK')) {
